                ...
                try {
                    if (line2.charAt(0) != '#') {
                        if (line2.charAt(line2.length() - 1) == '\\') {
                            if (continued != null) {
                                continued = new StringBuilder(String.valueOf(continued)).append(line2.substring(0, line2.length() - 1)).toString();
                            } else {
                                continued = line2.substring(0, line2.length() - 1);
                            }
                        } else if (continued != null) {
                            try {
                                parseLine(new StringBuilder(String.valueOf(continued)).append(line2).toString());
