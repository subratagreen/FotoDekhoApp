...
public abstract class Message implements Part {
    ...
    public static class RecipientType implements Serializable {
        ...
        /* renamed from: CC */
        public static final RecipientType f25CC = new RecipientType("Cc");

        /* renamed from: TO */
        public static final RecipientType f26TO = new RecipientType("To");
    ...
    public Address[] getAllRecipients() throws MessagingException {
        ...
        int i2;
        int i3;
        Address[] to = getRecipients(RecipientType.f26TO);
        Address[] cc = getRecipients(RecipientType.f25CC);
