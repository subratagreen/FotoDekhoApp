...
public class SharedFileInputStream extends BufferedInputStream implements SharedInputStream {
    ...
    /* renamed from: in */
    protected RandomAccessFile f42in;
    private boolean master;

    /* renamed from: sf */
    private SharedFile f43sf;
    ...
    static class SharedFile {
        ...
        /* renamed from: in */
        private RandomAccessFile f44in;

        SharedFile(String file) throws IOException {
            this.f44in = new RandomAccessFile(file, "r");
        }
    ...
    private void init(SharedFile sf, int size) throws IOException {
        ...
        this.f42in = sf.open();
        this.start = 0;
        this.datalen = this.f42in.length();
        this.bufsize = size;
    ...
    private void fill() throws IOException {
        ...
        this.count = this.pos;
        this.f42in.seek(this.bufpos + ((long) this.pos));
        ...
        int n = this.f42in.read(this.buf, this.pos, len);
        if (n > 0) {
    ...
    public InputStream newStream(long start2, long end) {
        if (this.f42in == null) {
            ...
            return new SharedFileInputStream(this.f43sf, this.start + ((long) ((int) start2)), (long) ((int) (end - start2)), this.bufsize);
        }
    }
