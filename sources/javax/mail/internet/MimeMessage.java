...
public class MimeMessage extends Message implements MimePart {
    ...
    private String getHeaderName(javax.mail.Message.RecipientType type) throws MessagingException {
        if (type == javax.mail.Message.RecipientType.f26TO) {
            return "To";
        }
        if (type == javax.mail.Message.RecipientType.f25CC) {
            return "Cc";
        }
    ...
    public synchronized DataHandler getDataHandler() throws MessagingException {
        if (this.f31dh == null) {
            this.f31dh = new DataHandler((DataSource) new MimePartDataSource(this));
        }
        return this.f31dh;
    }
    ...
    public Message reply(boolean replyToAll) throws MessagingException {
        ...
        reply.setRecipients(javax.mail.Message.RecipientType.f26TO, a);
        if (replyToAll) {
            Vector v = new Vector();
            InternetAddress me = InternetAddress.getLocalAddress(this.session);
            if (me != null) {
            ...
            Address[] a2 = eliminateDuplicates(v, getRecipients(javax.mail.Message.RecipientType.f26TO));
            if (a2 != null && a2.length > 0) {
                if (replyallcc) {
                    reply.addRecipients(javax.mail.Message.RecipientType.f25CC, a2);
                } else {
                    reply.addRecipients(javax.mail.Message.RecipientType.f26TO, a2);
                }
            }
            Address[] a3 = eliminateDuplicates(v, getRecipients(javax.mail.Message.RecipientType.f25CC));
            if (a3 != null && a3.length > 0) {
                reply.addRecipients(javax.mail.Message.RecipientType.f25CC, a3);
            }
            Address[] a4 = getRecipients(RecipientType.NEWSGROUPS);
            if (a4 != null && a4.length > 0) {
                reply.setRecipients((javax.mail.Message.RecipientType) RecipientType.NEWSGROUPS, a4);
            }
        }
    ...
    public void updateHeaders() throws MessagingException {
        ...
        updateMessageID();
        if (this.cachedContent != null) {
            this.f31dh = new DataHandler(this.cachedContent, getContentType());
            this.cachedContent = null;
            this.content = null;
            if (this.contentStream != null) {
                try {
