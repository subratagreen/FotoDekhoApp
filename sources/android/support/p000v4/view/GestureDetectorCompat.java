            ...
            switch (action & MotionEventCompat.ACTION_MASK) {
                ...
                case 1:
                    ...
                    if (this.mIsDoubleTapping) {
                        ...
                        velocityTracker.computeCurrentVelocity(IMAPStore.RESPONSE, (float) this.mMaximumFlingVelocity);
                ...
                case 6:
                    ...
                    this.mLastFocusY = focusY;
                    this.mDownFocusY = focusY;
                    this.mVelocityTracker.computeCurrentVelocity(IMAPStore.RESPONSE, (float) this.mMaximumFlingVelocity);
